...
struct AgentChatView: View {
    ...
    private var tabBar: some View {
        HStack(spacing: 0) {
            ...
            if app.operationMode == .humanPriority || app.operationMode == .gatekeeper {
                Button {
    ...
    private var workspaceView: some View {
        Group {
            if (app.operationMode == .humanPriority || app.operationMode == .gatekeeper) && showMiniExplorer {
                ResizableHSplit(
                    minLeft: 140, maxLeft: 600, minRight: 300, initialLeft: 220
                ) {
                    FileTreeView()
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            HStack {
                                ...
                                Button("Inject") {
                                    ...
                                    // Removed getCustomAnchor call that doesn't exist
                                    let anchorBase64 = "" 
